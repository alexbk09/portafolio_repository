...
<head>
    ...
    <title>Registrarse - Keiber Paez</title>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="name" name="name" type="text" required 
                                       class="appearance-none relative block w-full pl-10 pr-3 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent @error('name') border-red-500 @enderror"
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div class="relative">
                                    <input type="radio" id="freelancer" name="role" value="freelancer" 
                                           class="sr-only peer" {{ old('role') === 'freelancer' ? 'checked' : '' }}>
                                    <label for="freelancer" 
                                           class="flex flex-col items-center p-4 border-2 border-gray-200 rounded-lg cursor-pointer peer-checked:border-primary peer-checked:bg-blue-50 hover:bg-gray-50 transition-colors">
                                        <i class="fas fa-code text-2xl text-primary mb-2"></i>
                                        <span class="font-medium text-gray-900">Freelancer</span>
                                        <span class="text-sm text-gray-600 text-center">Ofrecer servicios</span>
                                    </label>
                                </div>
                                <div class="relative">
                                    <input type="radio" id="client" name="role" value="client" 
                                           class="sr-only peer" {{ old('role') === 'client' ? 'checked' : '' }}>
                                    <label for="client" 
                                           class="flex flex-col items-center p-4 border-2 border-gray-200 rounded-lg cursor-pointer peer-checked:border-primary peer-checked:bg-blue-50 hover:bg-gray-50 transition-colors">
                                        <i class="fas fa-briefcase text-2xl text-green-600 mb-2"></i>
                                        <span class="font-medium text-gray-900">Cliente</span>
                                        <span class="text-sm text-gray-600 text-center">Contratar servicios</span>
                                    </label>
                                </div>
                            </div>
                            @error('role')
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="password_confirmation" name="password_confirmation" type="password" required 
                                       class="appearance-none relative block w-full pl-10 pr-3 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
                                       placeholder="••••••••">
                            </div>
                        </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <label for="terms" class="ml-2 block text-sm text-gray-900">
                                Acepto los 
                                <a href="#" class="text-primary hover:text-secondary transition-colors">términos y condiciones</a>
                            </label>
                        </div>
                        ...
                        <div>
                            <button type="submit" 
                                    class="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-lg text-white bg-primary hover:bg-secondary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-colors">
